...
describe("Forms", function () {
    it("should generate input control", function () {
        ...
        assert.equal('<div class="form-group"><label for="txtInput">Label</label><input class="form-control" type="text" id="txtInput" placeholder="Placeholder" name="txtInput"/></div>', fn({
            type: "text",
            id: "txtInput",
    ...
    it("should generate simple input control", function () {
        ...
        assert.equal('<input class="form-control" type="text" id="txtInput" placeholder="Placeholder"/>', fn({
            type: "text",
            id: "txtInput",
            placeholder: "Placeholder"
        }));
    ...
    it("should generate a checkbox", function () {
        ...
        assert.equal('<div class="checkbox"><label><input type="checkbox" name="txtCheckbox" id="txtCheckbox"/>Checkbox</label></div>', fn({
            text: "Checkbox",
            name: "txtCheckbox",
            id: "txtCheckbox"
        }));
    ...
    it("should generate a checkbox inline style", function () {
        ...
        assert.equal('<div class="checkbox-inline"><input type="checkbox" name="txtCheckbox" id="txtCheckbox"/>Checkbox</div>', fn({
            text: "Checkbox",
            name: "txtCheckbox",
            id: "txtCheckbox"
        }));
    ...
    it("should generate a radio button", function () {
        ...
        assert.equal('<div class="radio"><label><input type="radio" name="txtRadio" id="txtRadio"/>Radio</label></div>', fn({
            text: "Radio",
            name: "txtRadio",
            id: "txtRadio"
        }));
    ...
    it("should generate a radio button inline style", function () {
        ...
        assert.equal('<div class="radio-inline"><input type="radio" name="txtRadio" id="txtRadio"/>Radio</div>', fn({
            text: "Radio",
            name: "txtRadio",
            id: "txtRadio"
        }));
    ...
    it("should generate a submit button", function () {
        ...
        assert.equal('<div class="form-group"><button class="btn btn-default" type="submit" name="btnSubmit" id="btnSubmit">Submit</button></div>', fn({
            text: "Submit",
            name: "btnSubmit",
            id: "btnSubmit"
        }));
    ...
    it("should generate a input group", function () {
        ...
        assert.equal('<div class="form-group"><div class="input-group"><div class="input-group-addon">Prepend</div><input type="text"/><div class="input-group-addon">Append</div></div></div>', fn({
            prepend: "Prepend",
            append: "Append"
        }));
    });
