(function (global, factory) {
...
}(this, function (exports, __acorn_js) {
  'use strict';
        ...
        if (/unterminated/i.test(msg)) {
          ...
          if (/string/.test(msg)) {
            replace = {
              ...
              type: __acorn_js.tokTypes.string,
  ...
  lp$1.parseStatement = function () {
    ...
    switch (starttype) {
      case __acorn_js.tokTypes._break:
      case __acorn_js.tokTypes._continue:
        this.next()
  ...
  lp$1.parseClass = function (isStatement) {
    ...
    while (!this.closes(__acorn_js.tokTypes.braceR, indent, line)) {
      ...
      if (!method.computed &&
        method.key.type === "Identifier" && method.key.name === "async" && this$1.tok.type !== __acorn_js.tokTypes.parenL && !this$1.canInsertSemicolon()) {
        this$1.parsePropertyName(method)
        isAsync = true
      } else {
        isAsync = false
  ...
  lp$2.parseExprAtom = function () {
    ...
    switch (this.tok.type) {
      ...
      case __acorn_js.tokTypes.num:
      case __acorn_js.tokTypes.string:
        node = this.startNode()
      ...
      case __acorn_js.tokTypes._null:
      case __acorn_js.tokTypes._true:
      case __acorn_js.tokTypes._false:
        node = this.startNode()
